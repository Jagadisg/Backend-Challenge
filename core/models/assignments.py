...
class Assignment(db.Model):
    ...
    def upsert(cls, assignment_new: 'Assignment'):
        if assignment_new.id is not None:
            ...
            assertions.assert_valid(assignment.content is not None, "Content can't be empty") 
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if auth_principal.principal_id is None:
            assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id, 'This assignment belongs to some other teacher to grade')
    ...
    def get_submitted_graded_assignments(cls):
        assignment = cls.filter(
                Assignment.state != AssignmentStateEnum.DRAFT
            ).all()
        assertions.assert_found(assignment, 'No assignment')
        return assignment
